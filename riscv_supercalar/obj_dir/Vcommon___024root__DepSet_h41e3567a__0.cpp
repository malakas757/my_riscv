...
void Vcommon_top_with_uart___sequent__TOP__top_with_uart__3(Vcommon_top_with_uart* vlSelf);
...
void Vcommon_top_with_uart___combo__TOP__top_with_uart__4(Vcommon_top_with_uart* vlSelf);
...
void Vcommon___024root___eval(Vcommon___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk)))) {
        ...
        Vcommon_top_with_uart___sequent__TOP__top_with_uart__3((&vlSymsp->TOP__top_with_uart));
    ...
    Vcommon_top_with_uart___combo__TOP__top_with_uart__4((&vlSymsp->TOP__top_with_uart));
