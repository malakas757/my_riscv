...
void Vcommon_if_stage___combo__TOP__pipeline__inst_if_stage__7(Vcommon_if_stage* vlSelf);
void Vcommon_pipeline___combo__TOP__pipeline__6(Vcommon_pipeline* vlSelf);
...
void Vcommon___024root___eval(Vcommon___024root* vlSelf) {
    ...
    Vcommon_if_stage___combo__TOP__pipeline__inst_if_stage__7((&vlSymsp->TOP__pipeline__inst_if_stage));
    Vcommon_pipeline___combo__TOP__pipeline__6((&vlSymsp->TOP__pipeline));
    // Final
