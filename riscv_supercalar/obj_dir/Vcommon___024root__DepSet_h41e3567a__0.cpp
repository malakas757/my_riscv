...
void Vcommon_if_stage___combo__TOP__pipeline__inst_if_stage__1(Vcommon_if_stage* vlSelf);
...
void Vcommon_pipeline___settle__TOP__pipeline__3(Vcommon_pipeline* vlSelf);
...
void Vcommon___024root___eval(Vcommon___024root* vlSelf) {
    ...
    // Body
    Vcommon_if_stage___combo__TOP__pipeline__inst_if_stage__1((&vlSymsp->TOP__pipeline__inst_if_stage));
