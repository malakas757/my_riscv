...
VL_ATTR_COLD void Vcommon_pipeline___settle__TOP__pipeline__2(Vcommon_pipeline* vlSelf) {
    ...
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones 
        = ((0x1dU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__0__KET____DOT__ms__DOT__done) 
              << 1U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid 
        = ((0x1dU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__0__KET____DOT__ms__DOT__reg_valid) 
              << 1U));
    ...
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_mpliers[3U] 
        = (IData)((vlSelf->inst_int0__DOT__inst_mult__DOT____Vcellout__mstage__BRA__0__KET____DOT__ms__mplier_out 
                   >> 0x20U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones 
        = ((0x1bU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__1__KET____DOT__ms__DOT__done) 
              << 2U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid 
        = ((0x1bU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__1__KET____DOT__ms__DOT__reg_valid) 
              << 2U));
    ...
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_mpliers[5U] 
        = (IData)((vlSelf->inst_int0__DOT__inst_mult__DOT____Vcellout__mstage__BRA__1__KET____DOT__ms__mplier_out 
                   >> 0x20U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones 
        = ((0x17U & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__2__KET____DOT__ms__DOT__done) 
              << 3U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid 
        = ((0x17U & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__2__KET____DOT__ms__DOT__reg_valid) 
              << 3U));
    ...
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones 
        = ((0xfU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_dones)) 
           | ((IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__mstage__BRA__3__KET____DOT__ms__DOT__done) 
              << 4U));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid 
        = ((0xfU & (IData)(vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_valid)) 
           ...
           & (((vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__intisq_control
                [7U][3U] >> 4U) & (~ vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__intisq_src2_state
                                   [7U])) | (~ (vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__intisq_control
                                                [7U][3U] 
                                                >> 4U))));
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_products[0U] = 0U;
    vlSelf->__PVT__inst_int0__DOT__inst_mult__DOT__internal_products[1U] = 0U;
    ...
    vlSelf->__PVT__ex_branch_in[0U] = (((IData)((((QData)((IData)(vlSelf->__PVT__inst_int1__DOT__branch_pc_latch)) 
                                        ...
                                        << 0xbU) | 
                                       (((IData)(vlSelf->__PVT__inst_int1__DOT__branch_update_GHSR_latch) 
                                         << 0xaU) | (IData)(vlSelf->__PVT__inst_int1__DOT__GHSR_restore_latch)));
    ...
    vlSelf->__PVT__inst_buffer__DOT__slot_rs1_in[2U] 
        = vlSelf->__PVT__inst_phyreg__DOT__prf_file
        [vlSelf->__PVT__slot2_src1_id];
    vlSelf->__PVT__inst_buffer__DOT__slot_rs2_addr_in[2U] 
        = vlSelf->__PVT__slot2_src2_id;
    ...
    __PVT__inst_int0__DOT__right_operand = __PVT__int0_rs2;
    ...
    if ((0x20000U & vlSelf->__PVT__inst_buffer__DOT__slot_reg_control
        ...
        vlSelf->__PVT__inst_int1__DOT__bju_branch_taken = 1U;
        vlSelf->__PVT__inst_int1__DOT__bju_branch_target_pc 
            = (0xfffffffeU & (__PVT__int1_rs1 + vlSelf->__PVT__inst_buffer__DOT__slot_reg_control
                              [1U][0U]));
    } else {
        vlSelf->__PVT__inst_int1__DOT__bju_branch_taken = 0U;
        vlSelf->__PVT__inst_int1__DOT__bju_branch_target_pc 
    ...
    if (((vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__inst_oldest_picker__DOT__l3_picker__DOT__big_cmp
          ...
          [1U]) & (vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__inst_oldest_picker__DOT__l3_picker__DOT__small_cmp
                   [0U] >= vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__inst_oldest_picker__DOT__l3_picker__DOT__big_cmp
                   [1U]))) {
        vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__old0_valid 
            = vlSelf->inst_is_stage__DOT__inst_intisq__DOT__inst_oldest_picker__DOT____Vcellinp__l3_picker__in_big_valid
            [0U];
        vlSelf->__PVT__inst_is_stage__DOT__inst_intisq__DOT__old1_valid 
            = vlSelf->inst_is_stage__DOT__inst_intisq__DOT__inst_oldest_picker__DOT____Vcellinp__l3_picker__in_small_valid
            [0U];
