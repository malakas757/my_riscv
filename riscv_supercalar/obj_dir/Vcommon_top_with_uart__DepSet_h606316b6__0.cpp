...
VL_INLINE_OPT void Vcommon_top_with_uart___sequent__TOP__top_with_uart__2(Vcommon_top_with_uart* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__write_address = vlSelf->__PVT__write_address;
    vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v0 = 0U;
    vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v4 = 0U;
    if (vlSymsp->TOP.rstn_uart) {
        if (vlSelf->__PVT__inst_uart__DOT__word_valid) {
            vlSelf->__Vdly__write_address = (0x3ffU 
                                             & ((IData)(4U) 
        ...
        vlSelf->__Vdlyvval__inst_uart__DOT__byte_reg__v0 
            = vlSelf->__PVT__inst_uart__DOT__byte_reg_next
            [3U];
        vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v0 = 1U;
        vlSelf->__Vdlyvval__inst_uart__DOT__byte_reg__v1 
            = vlSelf->__PVT__inst_uart__DOT__byte_reg_next
            [2U];
        vlSelf->__Vdlyvval__inst_uart__DOT__byte_reg__v2 
            = vlSelf->__PVT__inst_uart__DOT__byte_reg_next
            [1U];
        vlSelf->__Vdlyvval__inst_uart__DOT__byte_reg__v3 
            = vlSelf->__PVT__inst_uart__DOT__byte_reg_next
            [0U];
    } else {
        vlSelf->__Vdly__write_address = 0U;
        ...
        vlSelf->led = 0U;
        vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v4 = 1U;
    }
    ...
    vlSelf->__PVT__io_data_valid = ((IData)(vlSymsp->TOP.rstn_uart) 
...
VL_INLINE_OPT void Vcommon_top_with_uart___sequent__TOP__top_with_uart__3(Vcommon_top_with_uart* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcommon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcommon_top_with_uart___sequent__TOP__top_with_uart__3\n"); );
    // Body
    vlSelf->__PVT__write_address = vlSelf->__Vdly__write_address;
    if (vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v0) {
    ...
    if (vlSelf->__Vdlyvset__inst_uart__DOT__byte_reg__v4) {
    ...
    vlSelf->__PVT__inst_uart__DOT__word_valid = ((IData)(vlSymsp->TOP.rstn_uart) 
...
VL_INLINE_OPT void Vcommon_top_with_uart___combo__TOP__top_with_uart__4(Vcommon_top_with_uart* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcommon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcommon_top_with_uart___combo__TOP__top_with_uart__4\n"); );
    // Body
    vlSelf->__PVT__inst_uart__DOT__data_packet_next 
        = vlSelf->__PVT__inst_uart__DOT__data_packet_reg;
    if ((0U != vlSelf->__PVT__inst_uart__DOT__uart_state)) {
