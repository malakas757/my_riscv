...
VL_ATTR_COLD void Vcommon___024root___eval_initial(Vcommon___024root* vlSelf) {
    ...
    // Body
    Vcommon_pipeline___initial__TOP__top_with_uart__inst_cpu__1((&vlSymsp->TOP__top_with_uart__inst_cpu));
...
VL_ATTR_COLD void Vcommon___024root___eval_settle(Vcommon___024root* vlSelf) {
    ...
    // Body
    Vcommon_if_stage___settle__TOP__top_with_uart__inst_cpu__inst_if_stage__1((&vlSymsp->TOP__top_with_uart__inst_cpu__inst_if_stage));
    Vcommon_pipeline___settle__TOP__top_with_uart__inst_cpu__2((&vlSymsp->TOP__top_with_uart__inst_cpu));
    Vcommon___024root___settle__TOP__1(vlSelf);
    Vcommon_top_with_uart___settle__TOP__top_with_uart__1((&vlSymsp->TOP__top_with_uart));
    Vcommon_if_stage___settle__TOP__top_with_uart__inst_cpu__inst_if_stage__2((&vlSymsp->TOP__top_with_uart__inst_cpu__inst_if_stage));
}
