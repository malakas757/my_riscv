...
VL_ATTR_COLD void Vcommon___024root___eval_initial(Vcommon___024root* vlSelf) {
    ...
    // Body
    Vcommon_pipeline___initial__TOP__pipeline__2((&vlSymsp->TOP__pipeline));
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
}

VL_ATTR_COLD void Vcommon_if_stage___settle__TOP__pipeline__inst_if_stage__1(Vcommon_if_stage* vlSelf);
VL_ATTR_COLD void Vcommon_pipeline___settle__TOP__pipeline__1(Vcommon_pipeline* vlSelf);
VL_ATTR_COLD void Vcommon_pipeline___settle__TOP__pipeline__5(Vcommon_pipeline* vlSelf);
...
VL_ATTR_COLD void Vcommon___024root___eval_settle(Vcommon___024root* vlSelf) {
    ...
    Vcommon_pipeline___settle__TOP__pipeline__1((&vlSymsp->TOP__pipeline));
    Vcommon_pipeline___settle__TOP__pipeline__5((&vlSymsp->TOP__pipeline));
}
