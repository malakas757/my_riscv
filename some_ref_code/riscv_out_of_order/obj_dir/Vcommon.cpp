...
Vcommon::Vcommon(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , PC_stall{vlSymsp->TOP.PC_stall}
    , PC_flush{vlSymsp->TOP.PC_flush}
    , IF_stall{vlSymsp->TOP.IF_stall}
    , imem_miss{vlSymsp->TOP.imem_miss}
    , instr_req{vlSymsp->TOP.instr_req}
    , instr_resp{vlSymsp->TOP.instr_resp}
    , instr0_if_id{vlSymsp->TOP.instr0_if_id}
    , instr1_if_id{vlSymsp->TOP.instr1_if_id}
    , ex_branch_in{vlSymsp->TOP.ex_branch_in}
    , if_stage{vlSymsp->TOP.if_stage}
    , rootp{&(vlSymsp->TOP)}
{
}
